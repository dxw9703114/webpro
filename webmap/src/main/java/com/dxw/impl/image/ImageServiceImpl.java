...
public class ImageServiceImpl implements ImageService {
    ...
    public String upload(MultipartFile multipartFile) {
        ...
        String name = Objects.equals(multipartFile.getOriginalFilename(), null) ? UUID.randomUUID() + ".jpg" : multipartFile.getOriginalFilename();
        ...
        String path = imgFilePath + File.separator + filename;
